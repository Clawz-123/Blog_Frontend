        ...
        <header className='w-full border-b border-gray-200'>
            <div className='flex justify-between items-center h-16 px-6 md:px-10'>
                ...
                <div className="hidden md:flex gap-4">
                    <button className="px-6 py-2 text-black rounded-xl hover:bg-amber-600 hover:text-white transition duration-200 font-medium hover:shadow-lg">
                        Login
                    </button>
                    <button className="px-6 py-2 text-white bg-blue-700 rounded-xl hover:bg-blue-800 transition duration-200 font-medium hover:shadow-lg">
                        Sign Up
                    </button>
                </div>
            </div>
            ...
            {menuOpen && (
                <div className="md:hidden flex flex-col gap-4 px-6 pb-4 bg-white shadow-sm">
                    ...
                    <button className="w-full text-left text-white bg-blue-700 hover:bg-blue-800 rounded-md px-4 py-2 transition font-medium">
                        Sign Up
                    </button>
                </div>
            )}
